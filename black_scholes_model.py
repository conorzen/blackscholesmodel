...
def main():
    ...
    standard_deviation_of_anualised_returns = float(input("standard deviation of anualised returns: "))
    isTrue = input("time in days? y/n: ")


    call_price, put_price, d1, d2, T = (options_calculator(share_price, exercise_price,time_to_expiration,risk_free_rate,standard_deviation_of_anualised_returns,in_days=isTrue))
